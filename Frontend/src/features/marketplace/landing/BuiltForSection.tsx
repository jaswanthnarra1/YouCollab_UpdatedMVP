...
export function BuiltForSection() {
  return (
    <section className="relative py-20 px-6 overflow-hidden bg-slate-50 dark:bg-[#0F1115]" id="built-for">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3" role="list">
          {BUILT_FOR_TAGS.map((tag, i) => (
            <motion.span
              ...
              className="rounded-full border border-slate-200 dark:border-white/[0.08] bg-white dark:bg-white/[0.03] px-4 py-2 text-[13px] text-slate-600 dark:text-white/70"
            >
              {tag}
            </motion.span>
          ))}
